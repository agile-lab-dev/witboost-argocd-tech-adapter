...
ArgoCD is a continuous delivery (CD) system for Kubernetes that automates application deployments. It follows a "GitOps" model, where configurations are stored in a Git repository and automatically applied to the Kubernetes cluster.

Learn more on [ArgoCD official documentation](https://argo-cd.readthedocs.io/en/stable/).
