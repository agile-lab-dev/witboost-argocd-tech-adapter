...
| image.registry | string | `"registry.gitlab.com/AgileFactory/Witboost.Mesh/Provisioning/pipelines/witboost.mesh.provisioning.argocd"` | Image repository |
...
| otel | object | `{"collectorUrl":"http://localhost:5555","enabled":"false","metricExporter":"otlp","serviceName":"argocd-tech-adapter","tracesExporter":"otlp"}` | otel configuration |
